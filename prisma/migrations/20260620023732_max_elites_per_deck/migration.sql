...
CREATE TABLE "new_GameSettings" (
    ...
    "maxElitesPerDeck" INTEGER NOT NULL DEFAULT 4,
...
INSERT INTO "new_GameSettings" ("allowSellLastCopy", "gameName", "gameSubtitle", "id", "landingBackgroundUrl", "landingFooterLore", "landingTagline", "marketFeePercent", "maxCardsPerDeck", "maxDecksPerPlayer", "maxPerDeckCommon", "maxPerDeckEpic", "maxPerDeckLegendary", "maxPerDeckRare", "maxSpecialsPerDeck", "maxUnitsPerDeck", "maxWeathersPerDeck", "minCardsPerDeck", "minSpecialsPerDeck", "minUnitsPerDeck", "minWeathersPerDeck", "pityThresholdCommon", "pityThresholdEpic", "pityThresholdLegendary", "pityThresholdRare", "sellPriceCommon", "sellPriceEpic", "sellPriceLegendary", "sellPriceRare", "themePrimaryColor", "updatedAt") SELECT "allowSellLastCopy", "gameName", "gameSubtitle", "id", "landingBackgroundUrl", "landingFooterLore", "landingTagline", "marketFeePercent", "maxCardsPerDeck", "maxDecksPerPlayer", "maxPerDeckCommon", "maxPerDeckEpic", "maxPerDeckLegendary", "maxPerDeckRare", "maxSpecialsPerDeck", "maxUnitsPerDeck", "maxWeathersPerDeck", "minCardsPerDeck", "minSpecialsPerDeck", "minUnitsPerDeck", "minWeathersPerDeck", "pityThresholdCommon", "pityThresholdEpic", "pityThresholdLegendary", "pityThresholdRare", "sellPriceCommon", "sellPriceEpic", "sellPriceLegendary", "sellPriceRare", "themePrimaryColor", "updatedAt" FROM "GameSettings";
