    ...
    <main className="flex-1 max-w-6xl mx-auto w-full px-4 py-8">
      ...
      <SettingsForm
        initial={{
          ...
          minUnitsPerDeck: settings.minUnitsPerDeck,
          maxUnitsPerDeck: settings.maxUnitsPerDeck,
          minSpecialsPerDeck: settings.minSpecialsPerDeck,
          maxSpecialsPerDeck: settings.maxSpecialsPerDeck,
          minWeathersPerDeck: settings.minWeathersPerDeck,
          maxWeathersPerDeck: settings.maxWeathersPerDeck,
          maxElitesPerDeck: settings.maxElitesPerDeck,
